...
$string['selectbuttonalignment'] = 'Specify the button alignment';
$string['selectbuttonalignment_help'] = 'Specify where the buttons should be displayed: on the left, center, or right.';
$string['selectbuttonalignment_desc'] = 'Specify where the buttons should be displayed: on the left, center, or right.';
$string['selectbuttonalignmentleft'] = 'Left';
$string['selectbuttonalignmentcenter'] = 'Center';
$string['selectbuttonalignmentright'] = 'Right';
